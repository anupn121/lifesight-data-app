...
export const svgIcons: Record<string, JSX.Element> = {
  ...
  "CSV": (<svg viewBox="0 0 24 24" fill="white" className="w-3.5 h-3.5"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z" fill="none" stroke="white" strokeWidth="1.5" /><path d="M14 2v6h6M12 18v-6M9 15l3 3 3-3" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" /></svg>),
