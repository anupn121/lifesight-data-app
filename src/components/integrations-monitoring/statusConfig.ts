...
export const statusConfig: Record<IntegrationStatus, { color: string; dotColor: string; bg: string; borderColor: string }> = {
  ...
  CONNECTED: { color: "text-[#00bc7d]", dotColor: "bg-[#00bc7d]", bg: "", borderColor: "border-[#00bc7d]/20" },
  SYNC_ERROR: { color: "text-[#2b7fff]", dotColor: "bg-[#2b7fff]", bg: "bg-[#2b7fff]/5", borderColor: "border-[#2b7fff]/30" },
