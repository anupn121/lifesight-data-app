...
export const catalogIntegrations: CatalogIntegration[] = [
  ...
  { name: "Criteo", description: "Connect Criteo and start with automation", category: "Advertising", status: "NOT_CONNECTED", color: "#F48120", accounts: 0, icon: "cr", dataCategory: "paid_marketing" },
  { name: "Taboola", description: "Connect Taboola to use this integration with Lifesight", category: "Advertising", status: "NOT_CONNECTED", color: "#243B86", accounts: 0, icon: "tb", dataCategory: "paid_marketing" },
  { name: "Outbrain", description: "Connect Outbrain and start with automation", category: "Advertising", status: "NOT_CONNECTED", color: "#F47920", accounts: 0, icon: "ob", dataCategory: "paid_marketing" },
